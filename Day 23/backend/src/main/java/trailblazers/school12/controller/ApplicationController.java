...
public class ApplicationController {
    ...
    public String submitApplication(@PathVariable Long uid, @RequestBody Map<String, String> requestData) {
        ...
        String appemail = requestData.get("appemail"); 
        String address = requestData.get("address");
        applicationService.submitApplication(uid,name,fathername,emis,occupation,mobile,gender,appemail,address);
//        applicationService.postApplication(app);
