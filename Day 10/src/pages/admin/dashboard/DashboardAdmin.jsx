...
import StatBox from "../../../assets/components/dashboard-components/StatBox";
import ProgressCircle from "../../../assets/components/dashboard-components/ProgressCircle";
  ...
  return (
    <Box m="20px">
      ...
      <Box
        ...
        m="10px 0"
      >
        <Header1 title="DASHBOARD" subtitle="Welcome to your dashboard" />
