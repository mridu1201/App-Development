    ...
    <div>
        ...
        <section className='footer'>
          ...
          <div className="links-terms">
            <p className='f-links'>@Admission Box, All rights reserved<Link to='/privacy'><a className="privacy">Privacy & Policy</a></Link><Link to='/home/faq'><a className='FAQ'>FAQ</a></Link><Link to='/terms'><a className="tnc">Terms & Conditions</a></Link></p> 
          </div>
        </section>
    </div>
  )
